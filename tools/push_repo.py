...
SKIP_DIRS = {".git", "__pycache__", "build", ".eggs",
             "genshin_skin_cp1.egg-info", "node_modules", ".vscode-test"}
SKIP_SUFFIX = (".pyc", ".pyo", ".bak", ".orig", ".rej")
SKIP_FILES = {".mcp.json"}
SKIP_PREFIX = ("genshin_skin_cp1-",)
...
def collect(root):
    ...
    build 期的 genshin_skin_cp1-0.1.0/ 源码副本、__pycache__ 等一律排除。
    """
    out = []
...
def main():
    ...
    ap.add_argument("--message", default="feat: 原神CP壁纸套件1 · 米提亚×沃雅妮莎")
